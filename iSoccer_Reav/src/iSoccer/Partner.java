...
public class Partner
{
	...
	public static void Add_Partner(ArrayList<Partner> partners, double cpf, String name, String addres, String email, double telephone, double value_of_contribution, String status_of_pay, String type_of_partner)
	{
	...
	public static int Search_Partner(ArrayList<Partner> partners, String name, double cpf, boolean found)
	{	
	...
	public static String Take_Status(ArrayList<Partner> partners, String name, String status, double cpf, boolean found)
	{
		for(int i = 0;i < partners.size(); i ++)
		{
			if(partners.get(i).getName().equals(name) && partners.get(i).getCpf() == cpf)
	...
	public static void Alter_Status(ArrayList<Partner> partners, String status, double cpf)
	{
		for(int i = 0;i < partners.size(); i ++)
		{
	...
	public static void Alter_Contribution(ArrayList<Partner> partners, double value_of_contribution, double cpf)
	{
		for(int i = 0;i < partners.size(); i ++)
		{
			if(partners.get(i).getCpf() == cpf)
