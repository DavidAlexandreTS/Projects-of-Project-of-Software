...
public class Home
{
	...
	public static void main(String args [])
	{
		...
		Command Driver = new Driver();
		Command Lawyer = new Lawyer();
		Command Medical = new Medical();
		Command Physical_Trainer = new Physical_Trainer();
		Command Player = new Player();
		Command President = new President();
		Command Technician = new Technician();
		...
		Add_Worker Add_Workers = new Add_Worker(Cook,  Driver,  Lawyer,  Medical,  Physical_Trainer,  Player,  President,  Technician);
			...
			if(found == 1)
			{
				while(true)
				{
					...
					if(choice.equals("1"))
					{
						...
						if(choice.equals("1"))
						{
							Add_Workers.Add_President(presidents);
						}
						else if(choice.equals("2"))
						{
							Add_Workers.Add_Medical(medicals);
						}
						else if(choice.equals("3"))
						{
							Add_Workers.Add_Technician(technicians);
						}
						else if(choice.equals("4"))
						{
							Add_Workers.Add_Physical_Trainer(physical_trainers);
						}
						else if(choice.equals("5"))
						{
							Add_Workers.Add_Driver(drivers);
						}
						else if(choice.equals("6"))
						{
							Add_Workers.Add_Cook(cooks);
						}
						else if(choice.equals("7"))
						{
							Add_Workers.Add_Lawyer(lawyers);
						}
						else if(choice.equals("8"))
						{
							Add_Workers.Add_Player(players);
						}
