...
public class Account {
	...
	/*
	 * public Account(ArrayList<String> friends, String login, String username,
	 * String password) { this.login = login; this.username = username;
	 * this.password = password; this.Friends = friends; }
	 */
